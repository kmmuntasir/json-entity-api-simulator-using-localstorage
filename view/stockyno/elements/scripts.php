...
<script
	src="<?php echo $fullpath; ?>assets/malihu-custom-scrollbar-plugin/3.1.5/jquery.mCustomScrollbar.concat.min.js"></script>

<!-- Select2 Js -->
<script src="<?php echo $fullpath; ?>assets/select2/select2.min.js"></script>
